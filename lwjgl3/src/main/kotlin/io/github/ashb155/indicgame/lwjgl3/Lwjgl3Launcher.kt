...
package io.github.ashb155.indicgame.lwjgl3

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration
import io.github.ashb155.indicgame.IndicGame
...
fun main() {
    ...
    if (StartupHelper.startNewJvmIfRequired())
      return
    Lwjgl3Application(IndicGame(), Lwjgl3ApplicationConfiguration().apply {
        setTitle("indicgame")
